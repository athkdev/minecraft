/*
 *  This code is authored by alanko0511 (https://github.com/alanko0511/noisejs-typescript/blob/main/perlin.ts) - which is a TypeScript wrapper for the original Perlin and Simplex noise implementations authored by josephg (https://github.com/josephg/noisejs/blob/master/perlin.js).
 * */
